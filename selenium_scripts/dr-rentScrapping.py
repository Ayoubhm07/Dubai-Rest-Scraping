...
try:
    ...
    from_date.send_keys(Keys.RETURN)  # Premier appui sur Entrée
    ...
    to_date.send_keys(Keys.RETURN)  # Appui sur Entrée pour valider la date de fin

    time.sleep(1)  # Attendre que le focus soit perdu

    to_date.send_keys(Keys.RETURN)  # Appui sur Entrée après que le focus est perdu

    to_date.send_keys(Keys.RETURN)  # Deuxième appui sur Entrée après que le focus est perdu
